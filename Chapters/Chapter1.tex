...
Let's \graffito{Second-order complex homogeneus linear ordinary differential equations with variable coefficients} 
...
\begin{definition}
   ...
   Let $z_{0}\in\Omega$.
   \graffito{Ordinary and singular points of the differential equation} 
...
solutions $\psi$ \graffito{Initial conditions} of Eq.~\eqref{eq:ode} defined in
...
\begin{proof}
   ...
   Let \graffito{disk of convergence of the solution}
